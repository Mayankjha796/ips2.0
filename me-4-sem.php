...
<!-- navbar closed -->
  ...
  <tbody>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">ME402</td>
      <td class="text-center">Instrumentation & Control</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >3</th>
      <td class="text-center">ME403</td>
      <td class="text-center">Theory of Machines</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >4</th>
      <td class="text-center">ME404</td>
      <td class="text-center">Fluid Mechanics</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >5</th>
      <td class="text-center">ME405</td>
      <td class="text-center">Manufacturing Technology </td>
      <form>
      <td colspan="2"><input type="date" name="date">
