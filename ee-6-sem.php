...
<!-- navbar closed -->
  ...
  <tbody>
    <tr>
      <th >1</th>
      <td class="text-center">EE-601</td>
      <td class="text-center">Electrical Machine Design </td>
      <form>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">EE-602</td>
      <td class="text-center">Power System-II</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >3</th>
      <td class="text-center">EE-603</td>
      <td class="text-center">Power System Protection ( D.E )</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >4</th>
      <td class="text-center">EE-604</td>
      <td class="text-center">Powere Plant Engineering (O.E)</td>
      <form>
      <td colspan="2"><input type="date" name="date">
