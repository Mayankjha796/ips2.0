...
<!-- navbar closed -->
  ...
  <tbody>
    <tr>
      <th >1</th>
      <td class="text-center">CE-701</td>
      <td class="text-center">Geotechnical Engineering</td>
      <form>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">CE-702</td>
      <td class="text-center">Structural Design & Drawing(RCC-II) (D.E)</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >3</th>
      <td class="text-center">CE-703</td>
      <td class="text-center">Integrated Waste Management (O.E)</td>
      <form>
      <td colspan="2"><input type="date" name="date">
