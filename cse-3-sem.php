...
<body>
  ...
  <tbody>
    ...
    <tr>
      <th >4</th>
      <td class="text-center">CS304</td>
      <td class="text-center">Digital Systems</td>
      <form>
      <td colspan="2"><input type="date" name="date">
