...
<!-- navbar closed -->
  ...
  <tbody>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">IT302</td>
      <td class="text-center">Discrete Structure</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >3</th>
      <td class="text-center">IT303</td>
      <td class="text-center">Data Structure</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >4</th>
      <td class="text-center">IT304</td>
      <td class="text-center">Object Oriented Programming & Methodology</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >5</th>
      <td class="text-center">IT305</td>
      <td class="text-center">Digital Circuits & System </td>
      <form>
      <td colspan="2"><input type="date" name="date">
