...
<!-- navbar closed -->
  ...
  <tbody>
    <tr>
      <th >1</th>
      <td class="text-center">CE-801</td>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">CE-802</td>
      <td class="text-center">- (D.E)</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >3</th>
      <td class="text-center">CE-803</td>
      <td class="text-center">- (O.E)</td>
      <form>
      <td colspan="2"><input type="date" name="date">
