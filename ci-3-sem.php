...
<!-- navbar closed -->
  ...
  <tbody>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">CE302</td>
      <td class="text-center">Construction Materials</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >3</th>
      <td class="text-center">CE303</td>
      <td class="text-center">Surveying</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >4</th>
      <td class="text-center">CE304</td>
      <td class="text-center">Building Planning & Architecture</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >5</th>
      <td class="text-center">CE305</td>
      <td class="text-center">Strength of Materials</td>
      <form>
      <td colspan="2"><input type="date" name="date">
