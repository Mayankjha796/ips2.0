...
<body>
  ...
  <tbody>
    <tr>
      <th >1</th>
      <td class="text-center">CS-701</td>
      <td class="text-center">Software Architecture</td>
      <form>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">CS-702</td>
      <td class="text-center">Wireless & Mobile Computing (D.E)</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >3</th>
      <td class="text-center">CS-703</td>
      <td class="text-center">Disaster Management (O.E)</td>
      <form>
      <td colspan="2"><input type="date" name="date">
