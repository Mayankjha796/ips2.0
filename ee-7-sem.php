...
<!-- navbar closed -->
  ...
  <tbody>
    <tr>
      <th >1</th>
      <td class="text-center">EE-701</td>
      <td class="text-center">Electrical Drives</td>
      <form>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">EE-702</td>
      <td class="text-center">High Voltage Engineering (D.E)</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >3</th>
      <td class="text-center">EE-703</td>
      <td class="text-center">Advance Control System (O.E)</td>
      <form>
      <td colspan="2"><input type="date" name="date">
