...
<!-- navbar closed -->
  ...
  <tbody>
    <tr>
      <th >1</th>
      <td class="text-center">IT-701</td>
      <td class="text-center">Soft Computing</td>
      <form>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">IT-702</td>
      <td class="text-center">Cloud Computing (D.E)</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >3</th>
      <td class="text-center">IT-703</td>
      <td class="text-center">Internet of Things (O.E)</td>
      <form>
      <td colspan="2"><input type="date" name="date">
