...
<!-- navbar closed -->
  ...
  <tbody>
    <tr>
      <th >1</th>
      <td class="text-center">ME-601</td>
      <td class="text-center">Thermal Engineering & Gas Dynamics</td>
      <form>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">ME-602</td>
      <td class="text-center">Machine Component Design</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >3</th>
      <td class="text-center">ME-603</td>
      <td class="text-center">Product Design ( D.E )</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >4</th>
      <td class="text-center">ME-604</td>
      <td class="text-center">Renewable Energy Technology (O.E)</td>
      <form>
      <td colspan="2"><input type="date" name="date">
