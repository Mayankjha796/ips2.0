...
<!-- navbar closed -->
  ...
  <tbody>
    <tr>
      <th >1</th>
      <td class="text-center">Bt401</td>
      <td class="text-center">Engineering Mathematics-III</td>
      <form>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">EE402</td>
      <td class="text-center">Elecrical Machine-I</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >3</th>
      <td class="text-center">EE403</td>
      <td class="text-center">Digital Electronics & Logic Design(DELD)</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >4</th>
      <td class="text-center">EE404</td>
      <td class="text-center">Power System-I</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >5</th>
      <td class="text-center">EE405</td>
      <td class="text-center">Control System </td>
      <form>
      <td colspan="2"><input type="date" name="date">
  ...
  <tbody>
   <tr>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">EE402</td>
      <td class="text-center">Electric Machine-I</td>
      <td colspan="2">
    ...
    <tr>
     ...
     <td class="text-center">EE405</td>
      <td class="text-center">Control System</td>
      <td colspan="2">
     <a href="#"> <button class="btn btn-light float-center" type="submit">Proceed...</button></a>
       </td>
    </tr>
  </tbody>
</table>
