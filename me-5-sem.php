...
<!-- navbar closed -->
  ...
  <tbody>
    <tr>
      <th >1</th>
      <td class="text-center">ME-501</td>
      <td class="text-center">IC Engines</td>
      <form>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">ME-502</td>
      <td class="text-center">Mechanical Vibrations</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >3</th>
      <td class="text-center">ME-503</td>
      <td class="text-center">Dynamics of Machine ( D.E )</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >4</th>
      <td class="text-center">ME-504</td>
      <td class="text-center">Finite Element Method (O.E)</td>
      <form>
      <td colspan="2"><input type="date" name="date">
