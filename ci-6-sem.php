...
<!-- navbar closed -->
  ...
  <tbody>
    <tr>
      <th >1</th>
      <td class="text-center">CE-601</td>
      <td class="text-center">Structural Design & Drawing (RCC-I)</td>
      <form>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">CE-602</td>
      <td class="text-center">Environmental Engineering-I</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >3</th>
      <td class="text-center">CE-603</td>
      <td class="text-center">Water Resources Engineering ( D.E )</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >4</th>
      <td class="text-center">CE-604</td>
      <td class="text-center">Fluid Mechanics-II (O.E)</td>
      <form>
      <td colspan="2"><input type="date" name="date">
