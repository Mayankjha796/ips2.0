...
<!-- navbar closed -->
  ...
  <tbody>
    <tr>
      <th >1</th>
      <td class="text-center">CE-501</td>
      <td class="text-center">Fluid Mechanics-I</td>
      <form>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">CE-502</td>
      <td class="text-center">Transportation Engg.-II</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >3</th>
      <td class="text-center">CE-503</td>
      <td class="text-center">Structural Analysis-II ( D.E )</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >4</th>
      <td class="text-center">CE-504</td>
      <td class="text-center">Remote Sensing & GIS (O.E)</td>
      <form>
      <td colspan="2"><input type="date" name="date">
