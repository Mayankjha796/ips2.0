...
<!-- navbar closed -->
  ...
  <tbody>
    <tr>
      <th >1</th>
      <td class="text-center">CS-501</td>
      <td class="text-center">Theory of Computation</td>
      <form>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">CS-502</td>
      <td class="text-center">Database Management System</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >3</th>
      <td class="text-center">CS-503</td>
      <td class="text-center">Data Analytics ( D.E )</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >4</th>
      <td class="text-center">CS-504</td>
      <td class="text-center">Internet & Web Technology (O.E)</td>
      <form>
      <td colspan="2"><input type="date" name="date">
