...
<!-- navbar closed -->
  ...
  <tbody>
    <tr>
      <th >1</th>
      <td class="text-center">ES301</td>
      <td class="text-center">Energy & Environmental Engineering</td>
      <form>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">EE302</td>
      <td class="text-center">Electromagnetic Field & Materials</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >3</th>
      <td class="text-center">EE303</td>
      <td class="text-center">Electrical Measurement & Measuring Instrument</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >4</th>
      <td class="text-center">EE304</td>
      <td class="text-center">Analog Electronics</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >5</th>
      <td class="text-center">EE305</td>
      <td class="text-center">Network Analysis </td>
      <form>
      <td colspan="2"><input type="date" name="date">
