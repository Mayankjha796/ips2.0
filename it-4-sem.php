...
<!-- navbar closed -->
  ...
  <tbody>
    ...
    <tr>
      <th >3</th>
      <td class="text-center">IT403</td>
      <td class="text-center">Analysis & Design of Algorithm</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >4</th>
      <td class="text-center">IT404</td>
      <td class="text-center">Analog & Digital Communication</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >5</th>
      <td class="text-center">IT405</td>
      <td class="text-center">Data base Management System </td>
      <form>
      <td colspan="2"><input type="date" name="date">
