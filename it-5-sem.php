...
<!-- navbar closed -->
  ...
  <tbody>
    <tr>
      <th >1</th>
      <td class="text-center">IT-501</td>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">IT-502</td>
      <td class="text-center">Computer Network</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >3</th>
      <td class="text-center">IT-503</td>
      <td class="text-center">Theory Of computation ( D.E-I )</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >4</th>
      <td class="text-center">IT-504</td>
      <td class="text-center">Java Programming (O.E-I)</td>
      <form>
      <td colspan="2"><input type="date" name="date">
