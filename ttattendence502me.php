...
if(isset($_POST['insert'])){
    ...
    $d=$date;
    include("mechcon.php");
    $sqldate="SELECT `date` FROM `sem5sub2att` WHERE 1";
            ...
            if(!$b){
               foreach ($att as $key=>$value){
                   if ($value=="present"){
                       ...
                       $present="INSERT INTO `sem5sub2att`( `rollno`, `name`, `branch`, `date`, `attendence`) VALUES ('$key' , '$name' , '$branch' , '$d' , 'present')";
                      ...
                      $select="SELECT *  FROM `tysemstu_login` WHERE `rollno`='$roll'";
                       ...
                       $present="INSERT INTO `sem5sub2att`( `rollno`, `name`, `branch`, `date`, `attendence`) VALUES ('$key' , '$name' , '$branch' , '$d' , 'absent')";
                       $resultpresent=mysqli_query($con,$present);
