...
<!-- navbar closed -->
  ...
  <tbody>
    <tr>
      <th >1</th>
      <td class="text-center">ME-701</td>
      <td class="text-center">Heat & Mass Transfer</td>
      <form>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">ME-702</td>
      <td class="text-center">Advanced Machining Design (D.E)</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >3</th>
      <td class="text-center">ME-703</td>
      <td class="text-center">Artificial Intelligence Technique (O.E)</td>
      <form>
      <td colspan="2"><input type="date" name="date">
