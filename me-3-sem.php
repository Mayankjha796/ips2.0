...
<!-- navbar closed -->
  ...
  <tbody>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">ME302</td>
      <td class="text-center">Thermodynamics</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >3</th>
      <td class="text-center">ME303</td>
      <td class="text-center">Materials of Technology</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >4</th>
      <td class="text-center">ME304</td>
      <td class="text-center">Strength of Material</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >5</th>
      <td class="text-center">ME305</td>
      <td class="text-center">Manufacturing Process</td>
      <form>
      <td colspan="2"><input type="date" name="date">
