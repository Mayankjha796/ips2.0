...
<!-- navbar closed -->
  ...
  <tbody>
    <tr>
      <th >1</th>
      <td class="text-center">Bt-101</td>
      <td class="text-center">Engineering Chemistry</td>
      <form>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">Bt-202</td>
      <td class="text-center">Engineering Mathematics-II</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >3</th>
      <td class="text-center">Bt-103</td>
      <td class="text-center">English For Communication</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >4</th>
      <td class="text-center">Bt-104</td>
      <td class="text-center">Basic Electrical & Electronics Engineering</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >5</th>
      <td class="text-center">Bt-105</td>
      <td class="text-center">Engineering Graphics </td>
      <form>
      <td colspan="2"><input type="date" name="date">
