...
<!-- navbar closed -->
  ...
  <tbody>
    ...
    <tr>
      <th >4</th>
      <td class="text-center">CS404</td>
      <td class="text-center">Computer Org. & Architecture</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >5</th>
      <td class="text-center">CS405</td>
      <td class="text-center">Operating Systems </td>
      <form>
      <td colspan="2"><input type="date" name="date">
