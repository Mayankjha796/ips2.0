...
<!-- navbar closed -->
  ...
  <tbody>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">CE402</td>
      <td class="text-center">Construction Technology</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >3</th>
      <td class="text-center">CE403</td>
      <td class="text-center">Structural Analysis-I</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >4</th>
      <td class="text-center">CE404</td>
      <td class="text-center">Transportation Engineering-I</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >5</th>
      <td class="text-center">CE405</td>
      <td class="text-center">Engineering Geology & Remote Sensing </td>
      <form>
      <td colspan="2"><input type="date" name="date">
