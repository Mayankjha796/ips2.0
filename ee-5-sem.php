...
<!-- navbar closed -->
  ...
  <tbody>
    <tr>
      <th >1</th>
      <td class="text-center">EE-501</td>
      <td class="text-center">Electric Machine-II</td>
      <form>
    ...
    <tr>
      <th >2</th>
      <td class="text-center">EE-502</td>
      <td class="text-center">Power Electronics</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >3</th>
      <td class="text-center">EE-503</td>
      <td class="text-center">Electrical Engg. Material ( D.E-I )</td>
      <form>
      <td colspan="2"><input type="date" name="date">
    ...
    <tr>
      <th >4</th>
      <td class="text-center">EE-504</td>
      <td class="text-center">Digital Control System (O.E-I)</td>
      <form>
      <td colspan="2"><input type="date" name="date">
